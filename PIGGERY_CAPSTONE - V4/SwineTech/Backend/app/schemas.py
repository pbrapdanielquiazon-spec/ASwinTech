...
class PigHealthOut(PigHealthIn):
    ...
    # echo the friendly name too (set by server from the supply row)
...
class PigHealthUpdate(BaseModel):
    ...
    treatment_supply_id: Optional[int] = None  # if provided, we’ll swap stock A with B
